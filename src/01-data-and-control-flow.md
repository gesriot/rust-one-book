...
>
> 18 ноября 2025 года Cloudflare пережила крупный сбой. X, ChatGPT, Canva и тысячи других сервисов перестали работать. Причина: один `unwrap()` в Rust-коде прокси-сервера FL2.
>
...
> ```
>
> Паника распространилась по всей глобальной сети Cloudflare. Около шести часов до полного восстановления.
>
